...
Nova.booting(function (Vue, router) {
    Vue.component('index-generate-password', __webpack_require__(3));
    Vue.component('detail-generate-password', __webpack_require__(6));
    Vue.component('form-generate-password', __webpack_require__(9));
});
    ...
    [
      _c("template", { slot: "field" }, [
        _c("div", { staticStyle: { display: "flex" } }, [
          ...
          _c("input", {
            staticClass:
              "btn btn-default btn-outline-primary ml-3 cursor-pointer",
            attrs: { type: "button", value: "Generate" },
            on: {
          ...
          _c("div", { staticClass: "tooltip" }, [
            _c(
              ...
              {
                staticClass:
                  "btn btn-default btn-outline-grey ml-3 cursor-pointer",
                attrs: { type: "button" },
                on: {
                  click: function($event) {
